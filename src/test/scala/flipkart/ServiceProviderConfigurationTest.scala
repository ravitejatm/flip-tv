...
import flipkart.reader.mycomponent.MyStreamReaderImpl
import flipkart.transformer.mycomponent.MyStreamTransformerImpl
import flipkart.writer.mycomponent.MyStreamWriterImpl
